export const data = {
    categories: ["Watersports", "Soccer", "Chess", "Running","Fishing"],
    products: [
        {
        ...
        {
            id: 6, name: "P7", category: "Fishing",
            description: "P7 (Fishing)", price: 4
        },
        {
            id: 7, name: "P8", category: "Fishing",
            description: "P8 (Fishing)", price: 99
        }
    ]
} 